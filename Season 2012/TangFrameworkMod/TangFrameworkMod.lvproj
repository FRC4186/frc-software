...
KeepAliveTimeout 60
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="Angle Offset Calculator.vi" Type="VI" URL="../Angle Offset Calculator.vi"/>
			<Item Name="Calculate RPM v3.vi" Type="VI" URL="../Calculate RPM v3.vi"/>
			<Item Name="Control loop new type.vi" Type="VI" URL="../Control loop new type.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Get Robot Competition Mode.vi"/>
			<Item Name="Internal Servomech Gyro Set Position.vi" Type="VI" URL="../Internal Servomech Gyro Set Position.vi"/>
			<Item Name="JayDrive.vi" Type="VI" URL="../JayDrive.vi"/>
			<Item Name="Launcher_Wheel_v4.vi" Type="VI" URL="../Launcher_Wheel_v4.vi"/>
			<Item Name="Linear Control v3.vi" Type="VI" URL="../Linear Control v3.vi"/>
			<Item Name="Open TurretDevRef.vi" Type="VI" URL="../Open TurretDevRef.vi"/>
			<Item Name="Period to RPM.vi" Type="VI" URL="../Period to RPM.vi"/>
			<Item Name="RPM_to_Motor_Input_v1.vi" Type="VI" URL="../RPM_to_Motor_Input_v1.vi"/>
			<Item Name="Speed Control 2.vi" Type="VI" URL="../Speed Control 2.vi"/>
			<Item Name="Stop Control v3.vi" Type="VI" URL="../Stop Control v3.vi"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			<Item Name="Arm_Control.vi" Type="VI" URL="../Arm_Control.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Ball_Collector.vi" Type="VI" URL="../Ball_Collector.vi"/>
			...
			<Item Name="Fire_Motor.vi" Type="VI" URL="../Fire_Motor.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Global Data.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Turret_Manual_Aim.vi" Type="VI" URL="../Turret_Manual_Aim.vi"/>
			<Item Name="Vision Processing Glenn.vi" Type="VI" URL="../Vision Processing Glenn.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
		</Item>
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="AutoDriveType.ctl" Type="VI" URL="../AutoDriveType.ctl"/>
			<Item Name="AutonomousType.ctl" Type="VI" URL="../AutonomousType.ctl"/>
			<Item Name="BasketType.ctl" Type="VI" URL="../BasketType.ctl"/>
			<Item Name="Control loop state.ctl" Type="VI" URL="../Control loop state.ctl"/>
			...
			<Item Name="FormulaChoose.ctl" Type="VI" URL="../FormulaChoose.ctl"/>
			<Item Name="StateMachineType.ctl" Type="VI" URL="../StateMachineType.ctl"/>
			<Item Name="Target Datum.ctl" Type="VI" URL="../Target Datum.ctl"/>
			<Item Name="TurretDevRef.ctl" Type="VI" URL="../TurretDevRef.ctl"/>
		</Item>
		<Item Name="Vision Support Code" Type="Folder">
			<Property Name="NI.SortType" Type="Int">0</Property>
			<Item Name="Aspect Ratio Score.vi" Type="VI" URL="../Aspect Ratio Score.vi"/>
			<Item Name="Compute Distance Glenn.vi" Type="VI" URL="../Compute Distance Glenn.vi"/>
			...
			<Item Name="Extract first matched pixels.vi" Type="VI" URL="../Extract first matched pixels.vi"/>
			<Item Name="Intersect of Line Descriptors.vi" Type="VI" URL="../Intersect of Line Descriptors.vi"/>
			<Item Name="Line Descriptor.ctl" Type="VI" URL="../Line Descriptor.ctl"/>
			<Item Name="Normalized Range Compare.vi" Type="VI" URL="../Normalized Range Compare.vi"/>
			<Item Name="Points to Line Descriptor.vi" Type="VI" URL="../Points to Line Descriptor.vi"/>
			<Item Name="Rectangularity Score.vi" Type="VI" URL="../Rectangularity Score.vi"/>
			<Item Name="Row-Col Processing.vi" Type="VI" URL="../Row-Col Processing.vi"/>
			<Item Name="RT Overlay Helper.vi" Type="VI" URL="../RT Overlay Helper.vi"/>
			<Item Name="Score Particles Glenn.vi" Type="VI" URL="../Score Particles Glenn.vi"/>
			...
			<Item Name="Update Target Value.vi" Type="VI" URL="../Update Target Value.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Bounding-box angles.vi" Type="VI" URL="../../../Framework_2013/Bounding-box angles.vi"/>
			<Item Name="Calculate Angle.vi" Type="VI" URL="../../../Framework_2013/Calculate Angle.vi"/>
			<Item Name="CameraResolutionInfo.ctl" Type="VI" URL="../../../Framework_2013/CameraResolutionInfo.ctl"/>
			<Item Name="Compute Distance.vi" Type="VI" URL="../../../Framework_2013/Compute Distance.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Documents and Settings/robot/Desktop/TangFramework/Builds</Property>
